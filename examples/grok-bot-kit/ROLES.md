...
kit_version `2026.09.03` — if the `kit_version` you saved in your skill is older than the `min_kit_version` in `GET https://api.craigmbrown.com/v1/services` → `kit`, re-read https://craigmbrown.com/blindoracle/grok-bot-kit/BOOTSTRAP.md first.
